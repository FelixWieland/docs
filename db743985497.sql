...
--
-- Host: 127.0.0.1
-- Erstellungszeit: 24. Jun 2018 um 20:40
...
CREATE TABLE `docs_by_creator` (
  ...
  `title` text NOT NULL,
  `description` text NOT NULL,
  `creation_dat` datetime NOT NULL DEFAULT '0000-00-00 00:00:00',
  `lastchange_dat` datetime NOT NULL DEFAULT '0000-00-00 00:00:00'
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
